...
assert.ok(app.includes('browserStorage.getItem(key)'), 'localStorage wrapper must use getItem');
assert.ok(app.includes('browserStorage.setItem(key, value)'), 'localStorage wrapper must use setItem');
