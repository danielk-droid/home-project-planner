...
export function deriveProject(projectType, answers = {}, property = {}) {
  ...
  return {
    ...
    condo: a.condo == null ? undefined : a.condo === 'yes',
    condoUncertain: a.condo === 'unsure',
    condoApproval: a.condoApproval === 'yes',
    condoApprovalUncertain: a.condo === 'yes' && a.condoApproval === 'unsure',
    demolition: a.demolition == null ? undefined : a.demolition === 'yes',
    demolitionUncertain: a.demolition === 'unsure',
    guttingMoreThanHalf: a.guttingExtent == null ? undefined : a.guttingExtent === 'yes',
    ...
    bathroomLayoutChange: a.layoutChange == null ? undefined : a.layoutChange === 'yes',
    ...
    exteriorConstruction: projectType === 'deck' || projectType === 'addition' || a.primaryWorkArea === 'exterior' || exteriorAnswer === 'yes' || a.exteriorChange === 'yes' || ['structure','opening','surface'].includes(a.exteriorChangeDetail),
    exteriorUncertain,
    expansion: projectType === 'addition' || (a.exteriorExpansion == null && a.siteWork == null ? undefined : (a.exteriorExpansion === 'yes' || a.siteWork === 'yes')),
    sleepingRoomAdded: a.sleepingRoomAdded == null && a.sleepingUse == null ? undefined : (a.sleepingRoomAdded === 'yes' || a.sleepingUse === 'sleeping'),
    ...
    ventilationWork: a.newVentilation == null ? undefined : a.newVentilation === 'yes',
    ventilationUncertain: a.newVentilation === 'unsure',
    windowWork: a.newWindow == null && a.windowsOrDoors == null ? undefined : (a.newWindow === 'yes' || a.windowsOrDoors === 'yes'),
    ...
    localLandmark: a.historicLocalLandmark == null ? undefined : a.historicLocalLandmark === 'yes',
    preservationRestriction: a.historicPreservationRestriction == null ? undefined : a.historicPreservationRestriction === 'yes',
    nationalRegister: a.historicNationalRegister == null ? undefined : a.historicNationalRegister === 'yes',
